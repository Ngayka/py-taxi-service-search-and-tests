...
class ModelTests(TestCase):
    ...
    def test_car_info(self):
        driver = Driver.objects.create(username='test_username', first_name='test_first_name', last_name='test_last_name',
                                   license_number='AAA43434')
        manufacturer = Manufacturer.objects.create(id=1, name='test_manufacturer', country='test_country')
        model = "test_model"
